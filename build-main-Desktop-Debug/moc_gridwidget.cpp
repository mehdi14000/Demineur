...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GridWidget_t, stringdata) + ofs \
...
const QMetaObject GridWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GridWidget.data,
      qt_meta_data_GridWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GridWidget.stringdata))
